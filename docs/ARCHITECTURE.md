...
|------------|-----------|
| **Απόφαση Handover** | Fixed/tuned A3, strict ML, και complexity-aware ML+A3 |
...
Τα παλαιά ποσοτικά αποτελέσματα θεωρούνται ιστορικά. Η τρέχουσα θέση της
διπλωματικής είναι adaptive: tuned A3 μπορεί να είναι καλύτερο σε sparse/simple
regimes, ενώ η ML πρέπει να αποδείξει βελτίωση σε high-candidate-complexity
regimes μέσω validated offline replay και ξεχωριστής live validation. Μην
χρησιμοποιείτε αριθμούς ως thesis-final evidence χωρίς νέο validation report.
...
│  │  ┌──────────────────┐  ┌──────────────────┐  ┌──────────────────┐                   │ │
│  │  │    ML Mode       │  │    A3 Mode       │  │ Complexity Gate  │                   │ │
│  │  │  (LightGBM)      │  │  (3GPP TS 38.331)│  │ (A3 or strict ML)│                   │ │
│  │  └────────┬─────────┘  └────────┬─────────┘  └────────┬─────────┘                   │ │
│  │           └─────────────────────┴─────────────────────┘                             │ │
│  │                                     │                                               │ │
│  │  ┌──────────────────────────────────┴──────────────────────────────────┐            │ │
