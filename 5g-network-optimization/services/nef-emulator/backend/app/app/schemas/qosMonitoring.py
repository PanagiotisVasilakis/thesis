...
class Snssai(BaseModel):
    ...
    sd: Annotated[Optional[str], StringConstraints(pattern=r'^[0-9a-fA-F]{6}$')] = Field(default='000001', description="This value respresents the Slice Differentiator, in hexadecimal representation.")
